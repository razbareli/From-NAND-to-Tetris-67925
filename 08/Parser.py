...
class Parser:
    ...
    def pre_process(self) -> None:
        ...
        for line in reversed(range(self.num_of_lines)):
            self.input_lines[line] = self.input_lines[line].split('//')[0]
            self.input_lines[line] = self.input_lines[line].strip()
            if not self.input_lines[line]:
